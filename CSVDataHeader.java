...
{
	//the headerColumnTypes variable contains the blue print for the data types 
	...
	//header[0] = "String"; headerColumnTypes[1] = "int"; headerColumnTypes[2] = "double";
	private String[] headerColumnTypes;
